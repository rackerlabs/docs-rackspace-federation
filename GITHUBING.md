...
2. Use the SSH URL for the forked repo to clone it to your local system:
    ...
    ```
    git clone git@https://github.rackspace.com:my-github-username/docs-rackspace-federation.git
    ```

3. Track the upstream repo:

    ```
    cd docs-rackspace-federation
    git remote add --track master upstream git@https://github.rackspace.com:rackerlabs/docs-rackspace-federation.git
    ```
...
10. Create a pull request (PR) to the upstream repo for your branch.
    ...
    a. Go to ``https://https://github.rackspace.com/rackerlabs/docs-rackspace-federation``.

    b. Click the **Create pull request** button.

    c. If this PR is related to an outstanding
      [GitHub issue](https://https://github.rackspace.com/rackerlabs/docs-rackspace-federation/issues),
      include a link to that GitHub issue in the comment.

11. The Information Development team reviews your PR.

12. If necessary, incorporate changes from the review, and make updates to
    your PR by adding more commits:
