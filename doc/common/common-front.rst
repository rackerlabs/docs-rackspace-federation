...
using the industry standard `SAML <http://docs.oasis-open.org/security/saml/Post2.0/sstc-saml-tech-overview-2.0.html>`_ protocol. 

|product name| is supported for users of Rackspace Cloud, Fanatical 
Support for AWS, and Managed Google Cloud Platform (XX CHANGE GCP NAME 
BEFORE PUBLISH XX). Dedicated Hosting accounts are not currently 
supported.
...
- Attribute Mapping (LINK TO AM GUIDE NOT REFERENCE) allows dynamic 
