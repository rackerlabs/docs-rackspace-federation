# -*- coding: utf-8 -*-
#
# Rackspace Developer documentation build configuration file.
#
...
html_title = 'Rackspace Federation v1 documentation'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Rackspace Federation v1'
...
htmlhelp_basename = 'docs-federationdoc'
...
latex_documents = [
  (master_doc, 'docs-rackspace-federation.tex',
   'Rackspace Federation User Guide',
   'Rackspace', 'manual'),
]
...
man_pages = [
    (master_doc, 'Rackspace Federation documentation',
     'Rackspace Federation documentation',
     'Rackspace', 1)
]
...
texinfo_documents = [
  (master_doc, 'docs-rackspace-federation', 'Rackspace Federation Documentation',
   'Rackspace', 'docs-racksapce-federation', 'Learn about using Federation',
   'Miscellaneous'),
]
